...
using DishesAPI.EndpointHandler;
...
namespace DishesAPI.Extensions
{
    public static class EndpointRouteBuilderExtensions
    {
            ...
            this IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            dishWithGuidEndpoints.MapGet("", DishesHandlers.GetDishByIdAsync)
                .WithName("GetDish")
                .WithOpenApi()
        ...
        public static void RegisterIngredientsEndpoints(
            this IEndpointRouteBuilder endpointRouteBuilder)
        {
            var ingredientsEndpoints =
                endpointRouteBuilder.MapGroup("/dishes/{dishId:guid}/ingredients")
                    .RequireAuthorization();
